...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!empty($_FILES['image']['name'])) {
        ...
        if ($imageFileType != "jpg" && $imageFileType != "png" && $imageFileType != "jpeg") {
            $status = "Sorry, only JPG, PNG and JPEG files are allowed.";
        } else {
    ...
    description='$description', price='$price', rrp='$rrp', quantity='$quantity', 
    date_created='$date_record', submittedby='$submittedby' $imageUpdate WHERE product_id=$product_id";
